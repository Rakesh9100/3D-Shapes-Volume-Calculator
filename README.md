...
A calculator that calculates the volume of different important and useful 3D geometrical shapes.
...
<p>
  ...
  <a href="https://www.w3schools.com/js/"><img src="https://img.icons8.com/color/70/000000/javascript--v1.png"/></a>
</p>
...
```
git clone https://github.com/<your-github-username>/3D-Shapes-Volume-Calculator.git
```
- Open `index.html` in your browser.
- Select your corresponding 3D shape from the drop-down menu.
